...
class MGN(nn.Module):
    def __init__(self, resnet, num_classes, num_dim=256):
        ...
        self.part1 = nn.Sequential(copy.deepcopy(resnet.layer3[1:]), copy.deepcopy(resnet.layer4))
        self.part2 = nn.Sequential(copy.deepcopy(resnet.layer3[1:]), copy.deepcopy(resnet.layer4))
        self.part3 = nn.Sequential(copy.deepcopy(resnet.layer3[1:]), copy.deepcopy(resnet.layer4))
...
def mgnv4_resnet50_512(num_classes, loss='softmax', **kwargs):
