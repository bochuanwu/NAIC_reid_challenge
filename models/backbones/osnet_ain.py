...
class OSNet(nn.Module):
    ...
    def __init__(self, num_classes, blocks, layers, channels, feature_dim=512, loss='softmax', conv1_IN=False,
                 **kwargs):
...
# Instantiation
##########
def osnet_ain_x1_0(num_classes=1000, pretrained=False, loss='softmax', **kwargs):
    model = OSNet(
        num_classes,
        blocks=[
