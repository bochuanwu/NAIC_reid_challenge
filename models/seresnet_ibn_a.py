...
__all__ = ['seresnet101_ibn_a']

model_urls = {
    'seresnet101_ibn_a': 'https://files.catbox.moe/tcmkv3.tar'
}
    ...
    def __init__(self, num_classes, loss, block, layers, zero_init_residual=False,
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, SEBottleneck_IBN):
...
def seresnet101_ibn_a(num_classes, loss='softmax', pretrained=True, **kwargs):
    ...
    model = ResNet_IBN(
        ...
        **kwargs)
    if pretrained:
        init_pretrained_weights(model, key='seresnet101_ibn_a')
    return model
