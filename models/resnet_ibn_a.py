#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2019/10/24 2:19 下午
# @Author  : wuh-xmu
# @FileName: resnet_ibn_a.py
# @Software: PyCharm
...
def resnet50_ibn_a(num_classes, loss='softmax', pretrained=True, **kwargs):
...
def resnet101_ibn_a(num_classes, loss='softmax', pretrained=True, **kwargs):
...
def resnet152_ibn_a(num_classes, loss='softmax', pretrained=True, **kwargs):
    """Constructs a ResNet-101-based ibn-a model.
    """
    model = ResNet_IBN(
        num_classes=num_classes,
        ...
        **kwargs)
    if pretrained:
        init_pretrained_weights(model, key='resnet152')
    return model