...
class BottleneckIBGN(nn.Module):
    expansion = 4

    def __init__(self, inplanes, planes, ibn=False, stride=1, downsample=None):
        super(BottleneckIBGN, self).__init__()
...
class ResNetIBGN(nn.Module):
    ...
    def __init__(self, num_classes, loss, block, layers, zero_init_residual=False,
        ...
        super(ResNetIBGN, self).__init__()
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, BottleneckIBGN):
...
def resnet101_ibgn(num_classes, loss='softmax', pretrained=True, **kwargs):
    """Constructs a ResNet-101-based ibn-a model.
    """
    model = ResNetIBGN(
        num_classes=num_classes,
        loss=loss,
        block=BottleneckIBGN,
        layers=[3, 4, 23, 3],
        last_stride=1,
        fc_dims=None,
        dropout_p=None,
