...
from models.senet import senet154, se_resnet50
...
class MGN(nn.Module):
    ...
    def forward(self, x):
        ...
        part1_local_softmax_features = torch.cat(part1_local_softmax_features, 1)
        part2_local_softmax_features = torch.cat(part2_local_softmax_features, 1)
        part3_local_softmax_features = torch.cat(part3_local_softmax_features, 1)
        return y, global_softmax_features + [part1_local_softmax_features, part2_local_softmax_features,
                                             part3_local_softmax_features]


def mgnv4_seresnet101v2_512(num_classes, loss='softmax', **kwargs):
