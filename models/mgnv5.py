...
_all__ = ['mgnv5_resnet101_256', 'mgnv5_seresnet101_256', 'mgnv5_seresnet101_512', 'mgnv5_resnext101_32x4d_256', 'mgnv5_resnext101_32x4d_512']
...
class MGN(nn.Module):
    def __init__(self, resnet, num_classes, num_dim=256):
        ...
        self.part0_f0_reduction = copy.deepcopy(reduction)
        ...
        self.part0_f0_bnneck = copy.deepcopy(bnneck)
        ...
        self.part0_classifier0 = copy.deepcopy(classifier)
    ...
    def forward(self, x):
        ...
        part0_f0_triplet_feature = self.part0_f0_reduction(self.global_pool(part0)).flatten(1)
        ...
        part0_f0_softmax_feature = self.part0_f0_bnneck(part0_f0_triplet_feature)
        ...
        global_triplet_features = [part0_f0_triplet_feature,
                                   part1_f0_triplet_feature, part2_f0_triplet_feature, part3_f0_triplet_feature,
                                   part4_f0_triplet_feature, part5_f0_triplet_feature, part6_f0_triplet_feature]

        global_softmax_features = [part0_f0_softmax_feature,
                                   part1_f0_softmax_feature, part2_f0_softmax_feature, part3_f0_softmax_feature,
        ...
        part0_y0 = self.part0_classifier0(part0_f0_softmax_feature)
...
def mgnv5_resnet101_256(num_classes, loss='softmax', **kwargs):
    resnet = resnet101_ibn_a(num_classes, loss=loss, **kwargs)
    model = MGN(resnet, num_classes, num_dim=256)
    return model

def mgnv5_seresnet101_256(num_classes, loss='softmax', **kwargs):
    resnet = seresnet101_ibn_a(num_classes, loss=loss, **kwargs)
    model = MGN(resnet, num_classes, num_dim=256)
    return model

def mgnv5_seresnet101_512(num_classes, loss='softmax', **kwargs):
    resnet = seresnet101_ibn_a(num_classes, loss=loss, **kwargs)
    model = MGN(resnet, num_classes, num_dim=512)
    return model

def mgnv5_resnext101_32x4d_256(num_classes, loss='softmax', **kwargs):
    resnet = resnext101_ibn_a_32x4d(num_classes, loss=loss, **kwargs)
    model = MGN(resnet, num_classes, num_dim=256)
    return model

def mgnv5_resnext101_32x4d_512(num_classes, loss='softmax', **kwargs):
    resnet = resnext101_ibn_a_32x4d(num_classes, loss=loss, **kwargs)
    model = MGN(resnet, num_classes, num_dim=512)
    return model
