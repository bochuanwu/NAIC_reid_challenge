#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @Time    : 2019/12/03 9:33 下午
# @author  : wuh-xmu
# @FileName: dilated_mgn.py.py
# @Software: PyCharm
...
def dilated_mgn_resnet50_256(num_classes, loss='softmax', **kwargs):
    resnet = dilated_resnet50_ibn_a(num_classes, loss=loss, **kwargs)
    model = MGN(resnet, num_classes, local_dim=256)
    return model


def dilated_mgn_resnet50_512(num_classes, loss='softmax', **kwargs):
    resnet = dilated_resnet50_ibn_a(num_classes, loss=loss, **kwargs)
