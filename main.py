...
from engine import ImageTripletEngine, InfenerceEngine, ImageDynamicEngine
...
def build_engine(cfg, datamanager, model, optimizer, scheduler):
    if cfg.data.is_train:
        ...
        if cfg.loss.name == 'dynamic':
            engine = ImageDynamicEngine(
                datamanager,
                model,
                optimizer,
                margin=cfg.loss.triplet.margin,
...
def main():
    ...
    log_name = 'test.log' if cfg.test.evaluate or not cfg.data.is_train else 'train.log'
