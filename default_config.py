...
def get_default_config():
    ...
    cfg.loss.ohem = CN()
    cfg.loss.ohem.weight_t = 1.  # weight to balance hard triplet loss
    cfg.loss.ohem.weight_x = 1.  # weight to balance cross entropy loss
    cfg.loss.ohem.weight_f = 1.  # weight to balance arcface loss
