...
def save_checkpoint(state, save_dir, mode='rank1', remove_module_from_keys=False):
    r"""Saves checkpoint.

    Args:
        state (dict): dictionary.
        save_dir (str): directory to save checkpoint.
        mode (str, optional): metric method. Default is 'rank1.
    ...
    # save best model
    fpath = osp.join(save_dir, 'model-best-{}.pth.tar'.format(mode))
